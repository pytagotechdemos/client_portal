  ...
  return (
    <FadeIn className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-surface border border-border rounded-xl p-6">
        <h2 className="text-xl font-bold text-white mb-6">Edit Tagihan {invoice.invoiceNumber}</h2>
        <form action={updateInvoice} className="space-y-4">
          ...
          <div className="pt-4 flex justify-end gap-3">
            <Link href={`/projects/${invoice.projectId}?tab=invoices`} className="btn btn-secondary text-sm">Batal</Link>
