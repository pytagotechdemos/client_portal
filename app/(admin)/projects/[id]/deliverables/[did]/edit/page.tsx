  ...
  return (
    <FadeIn className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-surface border border-border rounded-xl p-6">
        <h2 className="text-xl font-bold text-white mb-6">Edit Hasil Pekerjaan</h2>
        <form action={updateDeliverable} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select name="type" defaultValue={deliverable.type} className="w-full bg-background border border-border rounded-md px-3 py-2 text-foreground focus:border-primary focus:outline-none">
              ...
              <option value="COPY">Teks/Copy</option>
              <option value="OTHER">Lainnya</option>
            </select>
          </div>

          <div className="space-y-2">
            <label className="text-sm font-medium text-white">Ditugaskan Kepada</label>
          ...
          <div className="pt-4 flex justify-end gap-3">
            <Link href={`/projects/${params.id}?tab=deliverables`} className="btn btn-secondary text-sm">Batal</Link>
